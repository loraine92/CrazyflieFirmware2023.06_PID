...
typedef struct
{
  ...
  float error;        //< error
  float prevDesired;  //< previous set point
  float prevDeseadoSD;
...
/**
 * Calcula la derivada, se utiliza para hallar la derivada del setpoint y para calcular la acelaración del setpoint
 *
 * @param[in] pid         A pointer to the pid object.
...
/**
 * Calcula la segunda derivada, se utiliza para hallar la segunda derivada del setpoint 
 *
 * @param[in] pid         A pointer to the pid object.
 * @return valor derivado
 */
